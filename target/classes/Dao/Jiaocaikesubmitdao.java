...
public class Jiaocaikesubmitdao {
    ...
    public static void inster2(String name2,String reason,String classroom,String applytime1,String temail,String unit,String phone,String fixedphone){
        ...
        try {
          ...
          //  threelogin.setNumber2(number2);
            ...
            con = Link.getCon();
            String sql = "insert into lvtables(username,reason,classnumber,applytime1,temail,unit,phone,fixedphone) values(?,?,?,?,?,?,?,?);";
    ...
    public static void delect1( String username, String agree,String classroom,String applytime) throws Exception {
        ...
        PreparedStatement stmt=null;
        conn=Link.getCon();
        String sql="delete from lvtables where username='"+username+"'and"+" agree='"+agree+"'and "+"classroom='"+classroom+" 'and "+" applytime='"+applytime+"';";
    ...
    public static int choosecorrect(String classroom,String applytime) throws Exception {
        ...
        try {
            con = Link.getCon();
            stmt = con.createStatement();
            String sql = "select DISTINCT * from lvtables where classnumber='" + classroom + "' and "+"applytime1='" + applytime+"';";
            rs = stmt.executeQuery(sql);
            while (rs.next()){
                a++;
            }
